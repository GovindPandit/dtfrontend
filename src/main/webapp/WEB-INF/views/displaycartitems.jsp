        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="${pageContext.request.contextPath}/cartitem/disp/${cartItem.cartitemid}">
                    ...
                    <span class="product-new-label">${cartItem.product.productname}</span>
                ...
                <div class="product-content">
                    ...
                    <div class="block">
                    	...
                    	<br>
                        <span>Rs. ${cartItem.product.price}</span>
